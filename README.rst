...
* Go to https://github.com/nethesis/nethspot-docs and fork the project
...
You can also use the traditional way by cloning nethspot-docs
repository (https://github.com/nethesis/nethspot-docs ) to your
